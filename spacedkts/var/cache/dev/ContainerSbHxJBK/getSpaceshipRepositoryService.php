 ...
 */
class getSpaceshipRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SpaceshipRepository' shared autowired service.
     *
     * @return \App\Repository\SpaceshipRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SpaceshipRepository.php';

        return $container->privates['App\\Repository\\SpaceshipRepository'] = new \App\Repository\SpaceshipRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
